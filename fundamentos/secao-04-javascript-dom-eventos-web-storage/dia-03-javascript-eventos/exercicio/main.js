...
varLi.addEventListener('click', addClassTech);
...
input.addEventListener('keyup', switchText)
...
const redirect = () => {
  window.location.replace('https://alexvido.com.br')
}
